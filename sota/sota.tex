...
The architecture of adaptive object-models relies on a series of design patterns to allow the modification of the system model in run-time. The most fundamental building block of these systems is the \textsc{type square} pattern (see Fig.~\ref{fig:type_square}). This pattern relies on two other patterns, the \textsc{type-object} and \textsc{property} patterns.
