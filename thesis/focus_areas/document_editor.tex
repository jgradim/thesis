...
\textbf{FIXME: Introduce and explain the figure / solution below}
...
\begin{itemize}
  \item \textsc{System Memento} - used for versioning and handling \emph{Publications} as states
