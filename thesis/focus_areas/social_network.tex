...
\begin{itemize}
  \item \textbf{group\_professor:}
  \item \textbf{professor:}
  \item \textbf{group\_student:}
  \item \textbf{school\_professor:}
  \item \textbf{school\_student:}
  \item \textbf{parent:} establishes a parenthood relationship between two users
  \item \textbf{school\_coordinator:}
  \item \textbf{colleague:}
  \item \textbf{student:}
  \item \textbf{school\_parent:}
  \item \textbf{friend:}
\end{itemize}
