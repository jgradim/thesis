...
\supervisor{Supervisor}{Hugo Ferreira}{(Ph.D AbD)}

%% Uncomment committee stuff in the final version
\committeetext{Approved in oral examination by the committee:}
\committeemember{Chair}{João Pascoal Faria}{(Ph.D)}
\committeemember{External Examiner}{António Nestor Ribeiro}{(Ph.D)}
\committeemember{Supervisor}{Ademar Aguiar}{(Ph.D)}
\committeemember{Supervisor}{Hugo Ferreira}{(Ph.D AbD)}
\signature
\committeedate{11$^{th}$ February, 2011}
